...
export const BLOCK_TYPES = {
  hero: {
    ...
    fields: [
      ...
      { key: 'joinLine1', label: 'Join slide — line 1', type: 'text', default: 'Home of independent reporting,' },
      { key: 'joinLine2', label: 'Join slide — line 2', type: 'text', default: 'creative projects,' },
      { key: 'joinLine3', label: 'Join slide — line 3', type: 'text', default: 'and cultural critique at UNM' },
      {
        key: 'joinText',
